...
module.exports = {
  ...
  async messageRun(message, args, data) {
    ...
    // Add user to ticket
      ...
      if (args.length < 2) return message.safeReply("Porfavor proporciona el rol o miembro que deseas añadir");
      let inputId;
    ...
    // Remove user from ticket
      ...
      if (args.length < 2) return message.safeReply("Porfavor proporciona el rol o miembro que deseas eliminar");
      let inputId;
      if (message.mentions.users.size > 0) inputId = message.mentions.users.first().id;
      else if (message.mentions.roles.size > 0) inputId = message.mentions.roles.first().id;
      else inputId = args[1];
